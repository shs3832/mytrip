...
export type CreateBoardMutation = { createBoard: { _id: string, writer: string | null, title: string, contents: string, youtubeUrl: string | null, boardAddress: { _id: string, zipcode: string | null, address: string | null, addressDetail: string | null } | null } };
