...
export type BoardsItemSetFragment = { _id: string, writer: string | null, title: string, createdAt: unknown } & { ' $fragmentName'?: 'BoardsItemSetFragment' };
...
export type FetchTravelproductQuestionAnswersForListQuery = { fetchTravelproductQuestionAnswers: Array<{ _id: string, contents: string, createdAt: unknown, updatedAt: unknown, user: { ' $fragmentRefs'?: { 'TravelProductUserSetFragment': TravelProductUserSetFragment } } }> };
