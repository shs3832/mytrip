...
export type FetchTravelproductQuestionAnswersForListQuery = { fetchTravelproductQuestionAnswers: Array<{ _id: string, contents: string, createdAt: unknown, updatedAt: unknown, travelproductQuestion: { _id: string }, user: { _id: string, name: string, email: string } }> };
...
export type CreateTravelproductQuestionMutation = { createTravelproductQuestion: { _id: string, contents: string, createdAt: unknown, updatedAt: unknown, travelproduct: { _id: string }, user: { _id: string, name: string, email: string } } };
...
export type FetchTravelproductQuestionsQuery = { fetchTravelproductQuestions: Array<{ _id: string, contents: string, createdAt: unknown, updatedAt: unknown, travelproduct: { _id: string }, user: { _id: string, name: string, email: string } }> };
...
export type FetchTravelproductForDetailQuery = { fetchTravelproduct: { _id: string, name: string, remarks: string, price: number | null, contents: string, images: Array<string> | null, tags: Array<string> | null, pickedCount: number | null, travelproductAddress: { address: string | null, addressDetail: string | null, lat: number | null, lng: number | null } | null, buyer: { _id: string, name: string, email: string } | null, seller: { _id: string, name: string, email: string } | null } };
